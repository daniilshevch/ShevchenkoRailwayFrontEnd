...
export const CANCEL_TICKET_BOOKING_RESERVATION_BEFORE_PURCHASE = `${SERVER_URL}/Client-API/CompleteTicketBookingProcessing/Cancel-Ticket-Booking-Reservation`;