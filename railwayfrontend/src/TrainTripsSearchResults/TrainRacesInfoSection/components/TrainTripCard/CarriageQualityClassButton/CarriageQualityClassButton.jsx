...
function CarriageQualityClassButton({ trainRaceId, carriageType, qualityClass, generalTrainRaceInfo, data })
{
    ...
    const handleCarriageTypeAndQualityClassClick = (carriageType, qualityClass, trainRaceId) => {
        ...
        navigate(`/${trainRaceId}/carriages?type=${carriageType}&quality=${qualityClass}`);
    }
