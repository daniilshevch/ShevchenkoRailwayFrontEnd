...
const RegisterPage = () => {
    ...
    const handleRegister = async () => {
        try {
            ...
            setLoading(true);
            await userAuthenticationService.register(values);
            messageApi.success("Реєстрацію успішно виконано! Увійдіть у свій акаунт.");
            navigate('/login');
        } catch (error) {
            messageApi.error(error.message || "Помилка реєстрації");
        } finally {
            setLoading(false);
        }
    };
