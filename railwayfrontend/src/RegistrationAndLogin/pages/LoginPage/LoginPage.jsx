...
const LoginPage = () => {
    ...
    const handleLogin = async () => {
        try {
            ...
            await userAuthenticationService.login(values);
            messageApi.success("Вхід успішно виконано");
    ...
    const handleGoogleLogin = () => {
        window.location.href = userAuthenticationService.getGoogleLoginUrl(fromPage);
    };
